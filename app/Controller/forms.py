...
class ProfileForm(FlaskForm):
    ...
    research_topics = QuerySelectMultipleField('Select Resarch Topics', query_factory = all_fields, get_label = get_fieldlabel, allow_blank = False) #TODO: Add tags from relationship
